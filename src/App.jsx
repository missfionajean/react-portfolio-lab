...
function App() {
	...
	const featured = {
		name: "Swoon",
		blurb: "Swoon is an in-browser game that uses JavaScript DOM manipulation and extensive CSS to run a full press-your-luck dating sim on a single webpage! Icons made by me using Canva Pro. All other assets rendered using CSS.",
		image: "images/swoon.png",
		alt: "Swoon Screenshot",
		link: "https://missfionajean.github.io/browser-based-game/",
	};
	const mySkills = [
		{
			name: "JavaScript",
		...
		<>
			<div id="page">
				...
				>
					...
					<p>{featured.blurb}</p>
					<img src={featured.image} alt={featured.alt} width="450" />
					<a
						href={featured.link}
						style={{
							fontSize: 24,
